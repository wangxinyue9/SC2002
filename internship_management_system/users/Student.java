...
public class Student extends User
{
    ...
    public Student(int id, String userID, String name, int yearOfStudy, String major) // Edited
    {
    ...
    public void toggleAcceptedSomeOffer() {
        acceptedSomeOffer = !acceptedSomeOffer;
    }
    public boolean hasAcceptedSomeOffer() {
        return  acceptedSomeOffer;
    }
    /* EDITED PART */
